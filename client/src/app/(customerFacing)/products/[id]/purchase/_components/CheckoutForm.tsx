...
import { userOrderExits } from '@/app/actions'
...
const Form = ({ priceInCents, productId }: {priceInCents:number, productId : string}) => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        stripe.confirmPayment({ elements, confirmParams: { return_url: `${process.env.NEXT_PUBLIC_SERVER_URL}/stripe/purchase-success` } }).then(({ error }) => {
